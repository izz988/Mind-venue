...
<body>
    ...
    <div style="margin-bottom: 5%; margin-top: 50px;">
        <div class="alert alert-primary">
                Hasil pencarian dari "<strong><?php echo e($cari); ?></strong>"
            </div>
        <?php
            $modal = 0;
        ?>
       ...
       <div class="row" style="margin-right: 5%; margin-left: 5%;">
            <div class="col-11" style="padding-left: 10%;">
                <div class="container thread-card" onclick="location.href='<?php echo e($thr->id); ?>/thread'">
                                ...
                                <td>
                                    ...
                                    <tr>
                                        <td>
                                             ...
                                             <span style="font-size: 14px; padding-left: 10px;"><?php echo e($dibuat); ?></span>
                                        </td>  
                                    </tr>
                                </td>
                            </tr>
...
</html><?php /**PATH C:\xampp\htdocs\mindvenue\mind-vanue\resources\views/user/search_thread.blade.php ENDPATH**/ ?>