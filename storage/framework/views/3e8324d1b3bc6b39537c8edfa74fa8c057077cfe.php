	...
	<div class="container">
		<div class="row">
			...
			<div class="col" id="thread"  style="display: block;">
				<table class="table-admin" bgcolor="#F5F5F5">
					...
					<tr>
						<td class="td-admin" height="50px">
							<div class="data">
							<?php echo e($thr->title); ?>

							</div>
						</td>
						<td class="td-admin" height="50px">
							<div class="data">
								<?php echo e($thr->lastname); ?>
				...
				<nav aria-label="...">
					<ul class="pagination">
						<?php echo e($thread->links('partials.page')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\mindvenue\mind-vanue\resources\views/admin/thread_admin.blade.php ENDPATH**/ ?>