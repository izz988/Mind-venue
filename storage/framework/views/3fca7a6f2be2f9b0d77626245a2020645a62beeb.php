		...
		<div class="row">
			<div class="col-sm-3">
				...
				<center>
					...
					<a type="button" href="<?php echo e('admin/moderator'); ?>" class="btn">Moderator</a><br><br>
					<a type="button" href="<?php echo e('admin/thread'); ?>" class="btn">
					Thread</a>
					</center>
				</div>
			</div>
			<div class="col" id="user" style="display: block;">
				<table class="table-admin" bgcolor="#F5F5F5">
					...
					<?php $__empty_1 = true; $__currentLoopData = $user; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					<tr>
						<td class="td-admin" height="50px">
							<div class="data">
							<?php echo e($usr->lastname); ?>

							</div>
						</td>
						<td class="td-admin" height="50px">
							<div class="data">
								<?php echo e($usr->institution); ?>
				...
				<nav aria-label="...">
					<ul class="pagination">
						<?php echo e($user->links('partials.page')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\mindvenue\mind-vanue\resources\views/admin/index.blade.php ENDPATH**/ ?>