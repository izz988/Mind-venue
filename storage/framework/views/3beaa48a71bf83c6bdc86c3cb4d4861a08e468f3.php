	...
	<div class="container">
		<div class="row">
			<div class="col-sm-3">
				...
				<center>
					<a href="<?php echo e('/'); ?>" class="btn" name="btnradio" >Pengguna</a><br><br>
					<a type="button" href="#" class="btn">Moderator</a><br><br>
					<a type="button" href="<?php echo e('/thread'); ?>" class="btn">
					Thread</a>
					</center>
				</div>
			</div>
			<div class="col" id="moderator" style="display: block;">
				<table class="table-admin" bgcolor="#F5F5F5">
					...
					<?php $__empty_1 = true; $__currentLoopData = $moderator; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mod): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
					<tr>
						<td class="td-admin" height="50px">
							<div class="data">
							<?php echo e($mod->lastname); ?>

							</div>
						</td>
						<td class="td-admin" height="50px">
							<div class="data">
								<?php echo e($mod->institution); ?>
				...
				<nav aria-label="...">
					<ul class="pagination">
						<?php echo e($moderator->links('partials.page')); ?>
...
</html><?php /**PATH C:\xampp\htdocs\mindvenue\mind-vanue\resources\views/admin/moderator_admin.blade.php ENDPATH**/ ?>